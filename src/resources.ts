  ...
  [Platform.IOS]: {
    ...
    [ResourceType.SPLASH]: {
      resources: [
        ...
        { src: 'ios/splash/Default@2x~ipad~anyany.png', format: Format.PNG, width: 2732, height: 2732 },
        { src: 'ios/splash/Default@2x~ipad~comany.png', format: Format.PNG, width: 1278, height: 2732, orientation: Orientation.PORTRAIT },
        { src: 'ios/splash/Default@2x~iphone~anyany.png', format: Format.PNG, width: 1334, height: 1334 },
        { src: 'ios/splash/Default@2x~iphone~comany.png', format: Format.PNG, width: 750, height: 1334, orientation: Orientation.PORTRAIT },
        { src: 'ios/splash/Default@2x~iphone~comcom.png', format: Format.PNG, width: 1334, height: 750, orientation: Orientation.LANDSCAPE },
        { src: 'ios/splash/Default@3x~iphone~anyany.png', format: Format.PNG, width: 2436, height: 2436 },
        { src: 'ios/splash/Default@3x~iphone~anycom.png', format: Format.PNG, width: 2436, height: 1242, orientation: Orientation.LANDSCAPE },
        { src: 'ios/splash/Default@3x~iphone~comany.png', format: Format.PNG, width: 1242, height: 2436, orientation: Orientation.PORTRAIT },
      ],
      nodeName: 'splash',
      nodeAttributes: [NodeAttributes.SRC, NodeAttributes.WIDTH, NodeAttributes.HEIGHT],
      indexAttribute: NodeAttributes.SRC,
